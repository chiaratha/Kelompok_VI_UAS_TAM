...
public final class FragmentFavoriteBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView containerResepFav;

  private FragmentFavoriteBinding(@NonNull FrameLayout rootView,
      @NonNull RecyclerView containerResepFav) {
    this.rootView = rootView;
    this.containerResepFav = containerResepFav;
  }
  ...
  public static FragmentFavoriteBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.container_resep_fav;
      RecyclerView containerResepFav = ViewBindings.findChildViewById(rootView, id);
      if (containerResepFav == null) {
        break missingId;
      }

      return new FragmentFavoriteBinding((FrameLayout) rootView, containerResepFav);
    }
